...
startlevel:
	...
	CP_InitRndT((word)KEENJUMPUR1SPR); // 0, 1
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENJUMPUL1SPR); // 2, 3
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENDREAM3SPR); // 4, 5
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENDREAM3SPR); // 6, 7
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENRUNR1SPR); // 8, 9
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENRUNR2SPR); // 10, 11
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENRUNR3SPR); // 12, 13
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	CP_InitRndT((word)KEENRUNR4SPR); // 14,15
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
	gamestate.key[gamestate.key_index] = CP_RndT();
	gamestate.key_index++;
